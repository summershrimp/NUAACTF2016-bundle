...
if __name__ == '__main__':
    ...
    print "[*] Imported %d new categories, updated %d categories" % ((new_cat_count - old_cat_count), update_cat_count)
    ...
    print "[*] Imported %d new tasks, updated %d tasks" % ((new_task_count - old_task_count), update_task_count)